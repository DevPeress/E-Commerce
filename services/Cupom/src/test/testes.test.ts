...
describe("Verificar Database", () => {
  ...
  it("Deve informar que o cupom não existe", async () => {
    ...
    expect(result).toEqual({ success: false, error: "Não possui cupom esse ID!" });
  });
  ...
  it("Deve informar que o cupom não existe", async () => {
    ...
    expect(result).toEqual({ success: false, error: "Não possui cupom esse Nome!" });
  });
  ...
  it("Deve informar que o cupom não pode ser criado pois já existe um", async () => {
    ...
    expect(result).toEqual({ success: false, error: "Cupom com o mesmo nome criado já!" });
  });
